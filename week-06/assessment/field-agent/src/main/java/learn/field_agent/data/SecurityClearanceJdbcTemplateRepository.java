...
public class SecurityClearanceJdbcTemplateRepository implements SecurityClearanceRepository {
    ...
    public SecurityClearance findByName(String name) {
        final String sql = "SELECT security_clearance_id, name security_clearance_name FROM security_clearance WHERE name = ?;";
        return jdbcTemplate.query(sql, new SecurityClearanceMapper(), name).stream()
                .findFirst()
                .orElse(null);
    }
    ...
    public SecurityClearance add(SecurityClearance securityClearance) {
        ...
        // literally just following convention of the code in the project,
    ...
    public boolean deleteById(int securityClearanceId) {
        final String deleteAgentSecurityClearance = "DELETE FROM agency_agent WHERE security_clearance_id = ?";
        jdbcTemplate.update(deleteAgentSecurityClearance, securityClearanceId);
